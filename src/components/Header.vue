        ...
        <div class="container-xl">
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <button 
                                ...
                                @click="$emit('eliminar-carrito',carrito)"
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    <h1 class="display-2 fw-bold">Modelo {{guitarraModelo.nombre}}</h1>
                    <p class="mt-5 fs-5 text-white">{{guitarraModelo.descripcion}}</p>
                    <p class="text-primary fs-1 fw-black">${{guitarraModelo.precio}}</p>
                    <button 
                        type="button"
                        class="btn fs-4 bg-primary text-white py-2 px-5"
                        @click="$emit('agregar-carrito', guitarraModelo)"
